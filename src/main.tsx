    ...
    <div className="flex min-h-screen items-center justify-center p-6">
      <div className="max-w-md space-y-2 text-center">
        ...
        <p className="text-sm text-slate-600">
          <code>VITE_SUPABASE_URL</code> dan <code>VITE_SUPABASE_ANON_KEY</code> belum tersedia saat
          aplikasi dibangun. Setel keduanya di <code>.env</code> untuk pengembangan lokal, atau
          sebagai secret repositori untuk penerapan.
        </p>
      </div>
    </div>
  )
